...
{
    $did=$_GET['did'];
    $dq=mysqli_query($connection,"delete from tbl_contact where contact_id='{$did}'");
    if($dq)
    {
			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary " href="contact-add.php" role="button">
									Add
								</a>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h3 class="text-blue h3">Contact Table</h3> 
							<!-- <p>Admin Data</p> -->
						</div>
					</div>
					<table class="table table-striped">
						...
						<tbody>
							<?php
									...
									$q=mysqli_query($connection,"select * from tbl_contact");
									...
									while($data=mysqli_fetch_array($q))
									{
										...
										echo "<td>{$data['contact_subject']}</td>";
                                        echo "<td>{$data['contact_detail']}</td>";
										echo "<td><a href='contact-display.php?did={$data['contact_id']}' onclick='return check();'> Delete</a></td>"; 
										echo "</tr>";
										echo "</tr>"; 
									}
