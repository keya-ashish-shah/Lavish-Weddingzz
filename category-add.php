<?php
    ...
    if($_POST)
    {
        ...
        $q=mysqli_query($connection,"insert into tbl_category (category_name,category_photo) values ('{$name}','{$filename}');");
        if($q)
        {
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="clearfix">
						<div class="pull-left">
							<h3 class="text-blue h3">Category Form</h3>
						</div>
					</div>
					<form method="post" id="myform"enctype="multipart/form-data">
						<div class="form-group">
							<label> Name</label>
							<input class="form-control" name="categoryname" type="text" placeholder="Enter Category Name.." required>
						</div>
