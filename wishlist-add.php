...
<body>
	...
	<?php
		...
		if($_POST){ 
			...
			$q=mysqli_query($connection,"insert into tbl_wishlist(vendor_id,client_id) values('{$vid}','{$cid}')");
			if($q){
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Wishlist Form</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h3 class="text-blue h3">Wish List  Form</h3>
						</div>
					</div>
