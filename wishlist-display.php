			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Wishlist Table</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary " href="wishlist-add.php" role="button">
									Add
								</a>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h3 class="text-blue h3">Wishlist Table</h3> 
						</div>
					</div>
					<table class="table table-striped">
						...
						<tbody>
							<?php
									...
									$q=mysqli_query($connection,"select * from tbl_wishlist");
									...
									while($data=mysqli_fetch_array($q))
									{
										...
										echo "<td><a href='wishlist-display.php?did={$data['wishlist_id']}' onclick='return check();'> Delete</a></td>"; 
										echo "</tr>";
										echo "</tr>"; 
									}
