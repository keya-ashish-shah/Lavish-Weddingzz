...
if(isset($_POST['singlebutton']))
{
    ...
    if($count==1)
    {
       ...
       mysqli_query($connection,"update tbl_client set client_password='{$newotp}' where client_email='{$email}'");

        $msg = "Hello <br/>your new password is ".$newotp;
        ...
        try {
            ...
            $mail->addAddress($email, $data['client_name']);     //Add a recipient
    ...
    {
        echo "<script>alert('Email not Found');window.location='client-forget-password.php'</script>";
    }
}
?>
