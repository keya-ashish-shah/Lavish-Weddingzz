<?php
    ...
    $sq=mysqli_query($connection,"select * from tbl_area where area_id='{$eid}'");
    ...
    $uq=mysqli_query($connection,"update tbl_area set area_name='{$name}',pincode='{$pincode}' where area_id='{$eid}'");
    if($uq)
    {
            echo "<script>alert('Record Updated');window.location='area-display.php';</script>";
    }
}
?> 
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post">
                        ...
                        <div class="form-group">
							...
							<input class="form-control" name="areaname" value="<?php echo $row['area_name'] ?>" type="text" placeholder="Enter Area Name">
						</div>
						
						<div class="form-group">
							<label>Pincode</label>
							<input class="form-control" name="pincode" value="<?php echo $row['pincode'] ?>" placeholder="5" type="text">
						</div>	
